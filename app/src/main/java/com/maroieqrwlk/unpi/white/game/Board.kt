...
import com.maroieqrwlk.unpi.white.Point
import com.maroieqrwlk.unpi.white.boundsCheck
...
class Board private constructor(
    ...
    val listen : MutableLiveData<Boolean> =  MutableLiveData<Boolean>(started)

    fun getStartedData() : MutableLiveData<Boolean>? {
